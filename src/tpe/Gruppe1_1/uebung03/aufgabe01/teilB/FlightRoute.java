...
public class FlightRoute {
     ...
     *          If the length is smaller than 0 or the minimumHeight is lower than 100.
     */
    FlightRoute(int length, int minimumHeight) throws SimulatorConfigurationException {
        ...
        if (minimumHeight <= 100)
            throw new SimulatorConfigurationException("The minimum height can't be smaller" +
                    " than 100 meters (" + minimumHeight + ")");
